...
const Footer = () => {
    return (
        <div className="bg-gray-800">
            <footer className="footer p-10 bg-gray-800 text-white w-[80%] flex justify-evenly mx-auto">
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t w-[80%] mx-auto bg-gray-800 text-white  border-base-300">
